...
public class FileDao {
    ...
    public void insert(FileDTO fileDTO) throws SQLException {
        Connection conn = DBUtil.getConnection();
        String sql = "insert into file(id, name, type, location, size, time) values (?,?,?,?,?,?)";
        PreparedStatement ptmt = conn.prepareStatement(sql);
        ...
        ptmt.setTimestamp(6, fileDTO.getTime());
        ptmt.executeUpdate();
    }
    ...
    public List<FileDTO> findAll() throws SQLException {
        ...
        Connection conn = DBUtil.getConnection();
        String sql = "select id, name, type, location,size,time from file";
        PreparedStatement ptmt = conn.prepareStatement(sql);
    ...
    public FileDTO findById(String id) throws SQLException {
        Connection conn = DBUtil.getConnection();
        String sql = "select id,name, type, location,size,time from file where id = ?";
        PreparedStatement ptmt = conn.prepareStatement(sql);
        ptmt.setString(1, id);
        ResultSet rs = ptmt.executeQuery();
